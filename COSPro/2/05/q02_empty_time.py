...
def func_c(time_table, class1, class2):
    answer = 0
...
def solution(time_table):
    answer = 0
    first_class = func_a(time_table)
    last_class = func_b(time_table)
    answer = func_c(time_table, first_class, last_class)
    return answer
